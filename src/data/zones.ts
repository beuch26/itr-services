...
export const zones: Zone[] = [
  {
    ...
    areasDetailed: [
      "Bruxelles-Ville", "Schaerbeek", "Anderlecht", "Ixelles", "Saint-Gilles",
      "Etterbeek", "Woluwe-Saint-Lambert", "Woluwe-Saint-Pierre", "Forest",
      "Uccle", "Jette", "Molenbeek-Saint-Jean", "Koekelberg", "Evere",
      "Auderghem", "Watermael-Boitsfort", "Ganshoren", "Berchem-Sainte-Agathe",
    ...
    localInfoTitle: "Votre plombier local à Bruxelles et ses alentours",
    localInfoText: "Basés au cœur de Bruxelles, nous intervenons en <strong class=\"text-dark-blue\">moins d'1 heure</strong> dans toutes les communes de la région bruxelloise. Des immeubles anciens de Schaerbeek aux maisons d'Anderlecht, nous adaptons nos interventions à chaque situation.",
  },
  {
    id: "waterloo",
